...
public async Task<Dictionary<string, bool>> CheckMultiplePermissions(HttpRequest request, string[] pageNames)
{
    ...
    foreach (var pageName in pageNames)
    {
        ...
        var hasManagePermission = userInfo.ServiceNames.Any(sn => sn.Contains("manage") );
        var hasViewPermission = userInfo.ServiceNames.Any(sn => sn.Contains("view"));
        pagePermissions[pageName] = hasManagePermission || hasViewPermission;
    }
